...
<head>
    ...
    <link href="<?= base_url('assets/bsb/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') ?>" rel="stylesheet" />
...
<!-- Autosize Plugin Js -->
<script src="<?= base_url('assets/bsb/plugins/autosize/autosize.js') ?>"></script>

<!-- Moment Plugin Js -->
<script src="<?= base_url('assets/bsb/plugins/momentjs/moment.js') ?>"></script>

<!-- Bootstrap Material Datetime Picker Plugin Js -->
<script src="<?= base_url('assets/bsb/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js') ?>"></script>
...
<!-- Demo Js -->
<script src="<?= base_url() ?>assets/bsb/js/pages/sweetalert2/new/sweetalert2.min.js"></script>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"> PRESENSI KARYAWAN</a>
            </div>
